export default {
    ...
    "38ec258d-c644-4f08-8635-3f7434c884dd": {
        description:
            "Place Seeds and connect it to a Vacuum Pump with a trigger to shoot seeds in to soil.",
    ...
    "3a3280e4-03b6-4a4d-9e02-e348478213c9": {
        description:
            "Throw them at night or other dark places to see things better.",
        title: "Glowstick",
    },
    ...
    "3e10ef67-383a-4b60-aa5b-b1173134e437": {
        description:
            "Cut down trees faster with the Saw Blade. Put it on a bearing that is connected to a engine and drive it in to a tree.",
        title: "Saw Blade",
    },
    ...
    "41960868-6245-47b5-97c4-f446e199812f": {
        description:
            "Makes bearings turn left and right. Can be connected to an engine to control the direction of travel. Can also be connected to triggers that can be activated from the saddle. Lvl 5 Driver's Saddle unlocks steering settings by pressing (E) on connected bearings with the Connect Tool.",
    ...
    "4c1cc8de-7af1-4f8e-a5c4-c583460af9e5": {
        description:
            "Enough of these can make things fly. Needs to be connected to a trigger or the driver's seat in order to activate. Upgrade for less gas consumption.",
        title: "Thruster 3",
    },
    ...
    "52855106-a95c-4427-9970-3f227109b66d": {
        description:
            "Adds shock absorption and provides stability. Great for vehicles to prevent them from easily flipping over. This suspension is small, but has a firmer bounce.",
        title: "Sport Suspension 5",
    },
    "54d84731-d9ec-435d-bc9d-d48e0763b1bf": {
        description:
            "A mechanics favorite food. Fills up all your meters to the max.",
        title: "Pizza Burger",
    },
    "54d8ef21-357d-48a3-a66d-40446f6bb686": {
        description:
            "A vegetarian alternative. Fills up all your meters to the max.",
        title: "Veggie Burger",
    },
    ...
    "5530e6a0-4748-4926-b134-50ca9ecb9dcf": {
        description:
            "Use to upgrade interactive parts and unlock bots in the Mechanic Station.",
        title: "Component Kit",
    },
    ...
    "5939f460-ab6c-48f2-9d07-a66845ce8cf2": {
        description:
            "Use it with the Vacuum Pump to make items travel through pipes.",
    ...
    "5cb15c93-4fa9-48da-9974-2e95ca6c9e1c": {
        description:
            "Let the Refinebot help you out and refine all your collected logs. Put them in by hand or by placing a Resource Collector with logs next to it.",
        title: "Refinebot",
    },
    ...
    "5eb8975b-0acf-43a7-ab4e-62ce661c0df7": {
        description:
            "Take a lovely nap in this comfy bed to respawn in it after your mechanic has been knocked out.",
        title: "Respawn Bed",
    },
    ...
    "69559e81-50fa-40ae-afa2-a22c1a49eb54": {
        description:
            "Connect it to a Water container with a trigger to water your plants more efficiently.",
        title: "Water Cannon",
    },
    ...
    "76331bbf-abbd-4b8d-bb54-f721a5b6193b": {
        description:
            "Place fertilizer and connect it to a Vacuum Pump with a trigger to shoot fertilizer on to plants.",
    ...
    "767a3121-2c31-473c-a5ab-27e188fdd55a": {
        description:
            "Use the Dressbot to make new clothes for your Mechanic. Just add your garment boxes and the right amount of cotton. You can also customise your look by using the blue wardrobe.",
        title: "Dressbot",
    },
    ...
    "77c2687c-2e13-4df8-996a-96fb26d75ee0": {
        description:
            "Makes bearings turn left and right. Can be connected to an engine to control the direction of travel. Can also be connected to triggers that can be activated from the seat. Lvl 5 Driver's Seat unlocks steering settings by pressing (E) on connected bearings with the Connect Tool.",
    ...
    "847daf20-02bf-4170-8699-9ab106acd29a": {
        description:
            "Used for avoiding standing. Take a seat and relax or add it to your vehicle so your friends can tag along. This Seat is not upgradable.",
        title: "Scrap Seat",
    },
    ...
    "869d4736-289a-4952-96cd-8a40117a2d28": {
        description:
            "Great for watering plants, unfortunately not good for drinking.",
        title: "Water",
    },
    ...
    "8fd2cf31-70b3-499a-bfb0-7e3d2c580258": {
        description:
            "Hides the connections on your creations from other mechanics. Connect it to a Battery container.",
    ...
    "97f449b6-c948-448b-b8b3-4448e3f6b956": {
        description:
            "The Vaccum Pump has many uses when connected to a trigger. Suck up water in to a water container. Pick up plants in to a chest. It can even shoot and place items from a chest.",
        title: "Vacuum Pump",
    },
    ...
    "9fde0601-c2ba-4c70-8d5c-2a7a9fdd122b": {
        description:
            "Shoots potatoes in a rapid fire. Uses a lot of potato ammo.",
        title: "Spudling Gun",
    },
    ...
    "a5985971-1f95-4373-a5d9-4ce0a3e74851": {
        description:
            "Emits a tracking signal that can be toggled in the Logbook.",
        title: "Beacon",
    },
    ...
    "a930a42f-63ed-4fb0-933e-56ce8a889cc5": {
        description:
            "Perfect for collecting and stacking logs. When full, place it next to a refinebot to turn logs in to blocks.",
    ...
    "ad35f7e6-af8f-40fa-aef4-77d827ac8a8a": {
        description:
            "Great for storing a lot of items. Can also be used with a Vacuum Pump.",
        title: "Large Chest",
    },
    ...
    "b63c6440-dfc2-4da7-acdb-3c385080b2e4": {
        description:
            "The Craftbot will help you craft everything from new blocks to useful interactive parts. A mechanics best friend.",
        title: "Craftbot",
    },
    ...
    "bd597ac9-6640-43ba-9bd8-ed584a794f13": {
        description:
            "Makes bearings turn left and right. Can be connected to an engine to control the direction of travel. Can also be connected to triggers that can be activated from the seat. This Drive's Seat is not upgradable.",
    ...
    "bfcfac34-db0f-42d6-bd0c-74a7a5c95e82": {
        description:
            "A starchy Potato. Can also be used as ammo for spud guns and mountable spud guns.",
        title: "Potato",
    },
    ...
    "c8b1bc7b-304e-44ce-9ca1-937b8e69d70c": {
        description:
            "Helps protecting your creation from damage. Connect it to a Battery container.",
    ...
    "d62ab46a-6d71-4858-85ba-c1a0e28e9abc": {
        title: "obj_robotparts_redtapebothead",
    },
    ...
    "da4833fd-f981-4e08-a9f7-48e630a7c146": {
        description:
            "Can Store more batteries and loads batteries in to Electric Engines and other interactive parts that require batteries when connected.",
    ...
    "e243f642-6934-42bb-8cdd-f8ff1704d411": {
        description:
            "Feed your fallen friends to get them back on their feet and back in action.",
    ...
    "ea10d1af-b97a-46fb-8895-dfd1becb53bb": {
        description:
            "Connect it to a Vacuum Pump that is under water to fil the Water Container with water.",
    ...
    "f08d772f-9851-400f-a014-d847900458a7": {
        description: "Keeps your food fresh.",
        title: "Fridge",
    },
